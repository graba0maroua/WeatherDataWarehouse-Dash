...
app.layout = html.Div(style={'backgroundColor': '#f9f9f9', 'padding': '20px'}, children=[
    html.H1("Évolution de la précipitation par station", style={'color': '#333333', 'textAlign': 'center','textSize':'23px' ,'fontFamily': 'Open Sans, sans-serif'
}),
    html.P("Ce graphique montre l'évolution de la précipitation au fil des ans pour une station météorologique donnée.",style={'color': '#333333', 'textAlign': 'center','fontSize':'1.4rem'}),
    html.Div([
        html.Div([
            dcc.Dropdown(
                id='country-dropdown',
